...
class TrainT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--max_epoch', type=int, default=2000, help='Maximum number of epoch for training')
        ...
        self.parser.add_argument('--milestones', default=[60_000], nargs="+", type=int,
        ...
        self.parser.add_argument("--seed", default=1039, type=int, help="Seed")
