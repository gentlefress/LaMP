# from data.t2m_dataset_v2 import Text2MotionDatasetEval, collate_fn # TODO
...
def get_dataset_motion_loader(opt_path, batch_size, fname, device):
    ...
    if opt.dataset_name == 't2m' or opt.dataset_name == 'kit':
        ...
        mean = np.load('../MotionCraft/data/datasets/motionx/humanml3d_align_mean.npy')
        std = np.load('../MotionCraft/data/datasets/motionx/humanml3d_align_std.npy')
