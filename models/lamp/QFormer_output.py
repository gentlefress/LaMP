...
@dataclass
class QFormer_Similarity(ModelOutput):
...
@dataclass
class QFormer_IntermediateOutput(ModelOutput):
    """
...
@dataclass
class QFormer_Output(ModelOutput):
    # some finetuned models (e.g. BlipVQA) do not compute similarity, thus optional.
    sims: Optional[QFormer_Similarity] = None

    intermediate_output: QFormer_IntermediateOutput = None
...
@dataclass
class QFormer_OutputFeatures(ModelOutput):
    """
