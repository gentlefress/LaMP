...
from models.vq.maskvq_trainer import RVQTokenizerTrainer
# from models.vq.binary_vqtrainer import BinarytokenizerTrainer
from options.vq_option import arg_parse
from data.t2m_dataset_mask import MotionDataset
...
# import models.vq.binary_vqvae as vqvae
import models.vq.mask_vqvae as vqvae
...
if __name__ == "__main__":
    ...
    if opt.dataset_name == "t2m":
        ...
        # dataset_opt_path = '../MotionGPT/checkpoints/t2m/Comp_v6_KLD005/opt.txt'
    ...
    # trainer = BinarytokenizerTrainer(opt, vq_model=net)
