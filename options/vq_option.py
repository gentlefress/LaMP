...
def arg_parse(is_train=False):
    ...
    parser.add_argument('--window_size', type=int, default=196, help='training motion length')
    parser.add_argument("--gpu_id", type=int, default=0, help='GPU id')

    ## optimization
    parser.add_argument('--max_epoch', default=50, type=int, help='number of total epochs to run')
    parser.add_argument('--total_iter', default=75000, type=int, help='number of total iterations to run')
    ...
    # KIT VQVAE parameter -> 50000
    parser.add_argument('--milestones', default=[37500, 62500], nargs="+", type=int, help="learning rate schedule (iterations)")
    ...
    parser.add_argument('--checkpoints_dir', type=str, default='/mnt/cap/karong/t2m/momask-codes/checkpoints', help='models are saved here')
    ...
    parser.add_argument('--vq_name', type=str, default="rvq_nq7_dc512_nc512_noshare_qdp0.2", help='Name of this trial')
    ...
    parser.add_argument("--quantizer", type=str, default='ema_reset', choices = ['ema', 'orig', 'ema_reset', 'reset', 'softvq', 'binary', 'cvq'], help="eps for optimal transport")
