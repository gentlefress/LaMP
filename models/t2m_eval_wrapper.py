...
class EvaluatorModelWrapper_w_LaMP(object):
    ...
    def _prepare_motion_encoder(self):
        # load your pretrained motion encoder in vqvae
        ckpt = torch.load('./checkpoints/t2m/qformer_motion_b100_re_ep75_t2m/model/net_best_acc.tar', map_location='cpu')
        itm_ckpt = {}
