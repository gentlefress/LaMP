...
from models.gmm_transformer.transformer import GMMTransformer
from models.gmm_transformer.transformer_trainer import GMMTrainer
...
def load_vq_model():
    ...
    #                         map_location='cpu')
    ckpt = torch.load(pjoin(vq_opt.checkpoints_dir, vq_opt.dataset_name, 'pretrained', 'model', 'net_last.pth'),
                            map_location='cpu')
    # kit 
    # ckpt = torch.load('/mnt/workspace/cap/karong/t2m/pretrained/VQVAE_KIT/net_best_fid.pth',
    #                     map_location='cpu')
...
if __name__ == '__main__':
    ...
    t2m_transformer = GMMTransformer(vq_model=vq_model,
    ...
    trainer = GMMTrainer(opt, t2m_transformer, vq_model)
